...
現在のアプリ版は **v1.4.4 (Beta)** です。v1系はすべてBeta版としてGitHubの
...
- `SummerCourseScheduler-Setup-1.4.4.exe`
- `SummerCourseScheduler-Portable-1.4.4.zip`
- `SHA256SUMS.txt`
...
`dist\SummerCourseScheduler-Portable-1.4.4.zip`を作ります。QML、Qt plugin、
...
.\.venv-release\Scripts\python.exe scripts\package_release.py checksums `
  ...
  dist\SummerCourseScheduler-Portable-1.4.4.zip `
  dist\SummerCourseScheduler-Setup-1.4.4.exe
