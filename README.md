...
現在のアプリ版は **v1.6.6 (Beta)** です。v1系はすべてBeta版としてGitHubの
...
- `SummerCourseScheduler-Setup-1.6.6.exe`
- `SummerCourseScheduler-Portable-1.6.6.zip`
- `SHA256SUMS.txt`
...
`dist\SummerCourseScheduler-Portable-1.6.6.zip`を作ります。QML、Qt plugin、
...
.\.venv-release\Scripts\python.exe scripts\package_release.py checksums `
  ...
  dist\SummerCourseScheduler-Portable-1.6.6.zip `
  dist\SummerCourseScheduler-Setup-1.6.6.exe
