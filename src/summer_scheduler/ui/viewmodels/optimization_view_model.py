...
_STAGE_LABELS = {
    ...
    "regular_teacher_shortfall_priority_5": "通常担当講師・優先度5の目標調整",
    "regular_teacher_shortfall_priority_4": "通常担当講師・優先度4の目標調整",
    "regular_teacher_shortfall_priority_3": "通常担当講師・優先度3の目標調整",
    "regular_teacher_shortfall_priority_2": "通常担当講師・優先度2の目標調整",
    "teacher_preference_penalty": "講師希望の調整",
    "teacher_continuity_penalty": "担当講師数の抑制",
    "same_day_concentration_penalty": "同一科目の日程分散",
    "worst_request_spacing_quality": "最も集中した生徒・科目の分散",
    "request_spacing_score": "受講回数に応じた授業間隔",
    "maximum_student_week_deviation": "生徒間の週別分散の公平化",
    "student_period_imbalance": "生徒ごとの週別分散",
    "period_distribution_score": "講習期間全体への分散",
    "active_teacher_day_count": "講師の出勤日数最小化",
    "maximum_teacher_week_deviation": "講師間の週別分散の公平化",
    "teacher_week_imbalance": "講師出勤日の週別分散",
