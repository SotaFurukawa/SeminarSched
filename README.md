...
現在は **v1.0.0-rc.3 / Phase 7リリース候補** です。これは本番公開済みの正式版を
意味しません。Phase 1の
...
- `SummerCourseScheduler-Setup-1.0.0-rc.3.exe`
- `SummerCourseScheduler-Portable-1.0.0-rc.3.zip`
- `SHA256SUMS.txt`
...
`dist\SummerCourseScheduler-Portable-1.0.0-rc.3.zip`を作ります。QML、Qt plugin、
