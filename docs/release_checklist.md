...
このチェックリストは `v1.0.0-rc.4` 相当のRelease候補を検証するためのものです。
...
- [ ] Release候補tagは `v1.0.0-rc.4` 形式で、正式版 `v1.0.0` と混同しない。
...
- [ ] artifact名が `SummerCourseScheduler-Portable-1.0.0-rc.4.zip` と一致する。
...
- [ ] artifact名が `SummerCourseScheduler-Setup-1.0.0-rc.4.exe` と一致する。
