...
Phase 0からPhase 7までの段階的な開発項目を実装し、現在は`1.7.1 (Beta)`の
...
- 未配置、講師希望、担当講師数、同日集中、複数月への分散、勤務可能枠に対する
...
- app version `1.7.1`とrelease channel `Beta`をpackage metadata、Qt application、
  About、log、帳票へ
